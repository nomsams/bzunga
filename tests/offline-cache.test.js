...
assert(workerSource.includes("${CACHE_PREFIX}v14") && offlineSource.includes('bzunga-offline-cache-ready-v14'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
