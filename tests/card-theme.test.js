...
const bazungaSource = fs.readFileSync(path.join(root, 'index.html'), 'utf8');
assert(bazungaSource.includes("getPropertyValue('--card-w')"), 'Bazunga layout math must use the active theme card width');
