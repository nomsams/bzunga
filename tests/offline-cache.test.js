...
assert(workerSource.includes("${CACHE_PREFIX}v20") && offlineSource.includes('bzunga-offline-cache-ready-v20'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
