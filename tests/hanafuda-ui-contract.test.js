...
for (const id of ['field-cards', 'draw-pile', 'local-hand', 'capture-modal', 'koi-choice-modal', 'btn-koi', 'btn-shobu', 'btn-card-overview', 'overview-modal', 'hanafuda-overview', 'btn-card-appearance', 'appearance-modal', 'game-card-front-select', 'game-card-back-select', 'spectator-controls', 'chat-drawer']) assert(html.includes(`id="${id}"`), `Missing ${id}`);
