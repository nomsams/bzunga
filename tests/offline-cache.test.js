...
assert(workerSource.includes("${CACHE_PREFIX}v15") && offlineSource.includes('bzunga-offline-cache-ready-v15'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
