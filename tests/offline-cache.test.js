...
assert(workerSource.includes("${CACHE_PREFIX}v12") && offlineSource.includes('bzunga-offline-cache-ready-v12'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
