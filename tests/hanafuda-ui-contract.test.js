...
assert(app.includes('bindCaptureInspection') && css.includes('.capture-group.is-inspecting'), 'Captured groups must enlarge briefly on click and on hover');
