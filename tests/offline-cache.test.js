...
assert(workerSource.includes("${CACHE_PREFIX}v19") && offlineSource.includes('bzunga-offline-cache-ready-v19'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
