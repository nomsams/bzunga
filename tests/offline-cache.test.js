...
assert(workerSource.includes("${CACHE_PREFIX}v16") && offlineSource.includes('bzunga-offline-cache-ready-v16'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
