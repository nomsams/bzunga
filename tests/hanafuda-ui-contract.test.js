...
assert(app.includes('openCardDetail(cardId)') && app.includes('card.japaneseName') && css.includes('.card-detail-japanese'), 'Reference cards must open bilingual detail views');
