...
assert(workerSource.includes("${CACHE_PREFIX}v22") && offlineSource.includes('bzunga-offline-cache-ready-v22'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
