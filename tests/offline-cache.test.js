...
assert(workerSource.includes("${CACHE_PREFIX}v11") && offlineSource.includes('bzunga-offline-cache-ready-v11'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
