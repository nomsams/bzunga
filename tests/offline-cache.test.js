...
assert(workerSource.includes("${CACHE_PREFIX}v13") && offlineSource.includes('bzunga-offline-cache-ready-v13'), 'A gameplay release must invalidate both the old cache and its stale ready indicator');
